...
DESTINATIONS = [
    ...
    {"country": "Канада", "city": "Торонто", "flag": "🇨🇦", "why": "Ниагарский водопад, скалистые горы Банфа, северное сияние и самые дружелюбные люди в мире.", "highlight": "Банф, Ниагарский водопад, Ванкувер, Квебек", "best_time": "Июнь – сентябрь (горы), декабрь – март (лыжи)", "budget": "от 10 000 ₽/день", "tip": "Canada ETA оформляется за $7 онлайн за несколько минут — не путай с визой в США", "visa": "eTA онлайн $7 (для безвизовых стран)", "tags": {"nature": ["Горы и природа"], "climate": ["Тепло +20–28", "Умеренный +10–20", "Холодно до +10"], "budget": ["100–150 000 ₽"], "vibe": ["Экстрим и активность", "Достопримечательности и UNESCO"]}},
    ...
    # ── Океания ───────────────────────────────────────────────────────
    {"country": "Австралия", "city": "Сидней", "flag": "🇦🇺", "why": "Большой Барьерный риф, Улуру, кенгуру, сиднейская опера и самый большой остров-континент.", "highlight": "Большой Барьерный риф, Улуру, Сидней, Тасмания", "best_time": "Сентябрь – ноябрь (юг), апрель – октябрь (север)", "budget": "от 11 000 ₽/день", "tip": "Driving licence обменивается без экзамена — арендуй авто и объезжай вдоль побережья", "visa": "ETA онлайн AUD 20", "tags": {"nature": ["Море и пляжи", "Горы и природа", "Пустыня и степи"], "climate": ["Жара +30 и выше", "Тепло +20–28"], "budget": ["100–150 000 ₽"], "vibe": ["Полный отдых и пляж", "Экстрим и активность", "Достопримечательности и UNESCO"]}},
    {"country": "Новая Зеландия", "city": "Окленд", "flag": "🇳🇿", "why": "Страна Средиземья, фьорды Милфорд-Саунда, гейзеры и самые добрые люди в южном полушарии.", "highlight": "Милфорд-Саунд, Роторуа, Квинстаун, трек Tongariro", "best_time": "Декабрь – февраль (лето ЮП), март – май (осень)", "budget": "от 10 000 ₽/день", "tip": "Campervan — лучший способ путешествовать: нет проблем с жильём, гибкий маршрут", "visa": "NZeTA онлайн NZD 23", "tags": {"nature": ["Горы и природа", "Море и пляжи"], "climate": ["Тепло +20–28", "Умеренный +10–20"], "budget": ["100–150 000 ₽"], "vibe": ["Экстрим и активность", "Достопримечательности и UNESCO", "Романтика и пары"]}},
