...
WHERE_TO_FLY_DATA = {
    ...
    "Февраль": [
        ...
        "🇲🇽 Мексика — +28°C, сухо. Юкатан, пирамиды майя, сенот",
    ...
    "Март": [
        ...
        "🇹🇿 Танзания — сухой сезон, +28°C. Занзибар, Серенгети",
        "🇮🇳 Индия (Гоа) — +32°C, конец сезона. Пляжи, форты",
        "🇲🇽 Мексика — +30°C. Оахака, Мехико",
    ...
    "Апрель": [
        ...
        "🇹🇳 Тунис — +22°C, сухо. Карфаген, Сиди-Бу-Саид, Сахара",
    ...
    "Сентябрь": [
        ...
        "🇹🇷 Турция — +28°C. Каппадокия, Эгейское побережье",
...
async def where_to_fly_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"Топ-10 направлений — сухой сезон, хорошая погода:\n\n"
        f"{lines}\n\n"
