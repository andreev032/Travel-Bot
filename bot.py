...
async def main_menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ── Feature buttons ──────────────────────────────────────────────────────
        ...
        photo = InputFile(open('kirill.jpg', 'rb'))
        await update.message.reply_photo(
            photo,
            caption=(
                "👤 О проекте\n\n"
                "Привет, я Кирилл Андреев — основатель «Как местный».\n\n"
                "Несколько лет назад я бросил нелюбимую работу и нелюбимый бизнес. Решил заниматься только тем, от чего горят глаза. Путешествия — именно это.\n\n"
                "🌍 Немного цифр:\n"
