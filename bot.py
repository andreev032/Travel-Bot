...
MAIN_MENU, ANSWERING, HELP_MENU, HELP_TOPIC, TRANSLATING, VISA_MENU, VISA_CATEGORY, \
    ...
    DRONE_MENU, DRONE_SECTION = range(14)
...
DRONE_ALLOWED_TEXT = """✅ *Дроны: Можно летать*

Страны где полёты разрешены свободно или с простой онлайн-регистрацией.

🇦🇺 *Австралия*
Макс. высота: 120 м | Визуальный контроль обязателен
Регистрация: CASA (casa.gov.au/drones) — бесплатно
Запрет: над людьми, аэропортами, нацпарками без разрешения
Штраф: до 11 000 AUD

🇦🇹 *Австрия*
Макс. высота: 120 м | Нужна онлайн-регистрация оператора
Регистрация: austro.control.at — €30/год
Штраф: до €22 000

🇦🇿 *Азербайджан*
Макс. высота: 100 м | Регистрация обязательна
Регистрация: в Госавиаадминистрации (mga.gov.az)
Штраф: до 5 000 AZN

🇦🇱 *Албания*
Макс. высота: 120 м | Онлайн-регистрация
Регистрация: AAC (aac.gov.al)
Штраф: до 500 000 ALL

🇩🇿 *Алжир*
Макс. высота: 100 м | Нужна регистрация
Штраф: до 500 000 DZD

🇦🇴 *Ангола*
Макс. высота: 120 м | Регистрация в INAVIC
Штраф: до $2 000

🇦🇩 *Андорра*
Макс. высота: 120 м | Следуй правилам EASA
Штраф: до €3 000

🇦🇷 *Аргентина*
Макс. высота: 120 м | Регистрация в ANAC (anac.gob.ar) — бесплатно
Штраф: до 300 000 ARS

🇦🇲 *Армения*
Макс. высота: 120 м | Регистрация в GCAA
Штраф: до 500 000 AMD

🇧🇸 *Багамы*
Макс. высота: 300 футов | Регистрация в CAAB
Штраф: до $10 000

🇧🇩 *Бангладеш*
Разрешено с регистрацией CAAB (caab.gov.bd)
Штраф: до 200 000 BDT
...
🇧🇪 *Бельгия*
Макс. высота: 120 м | Регистрация: droneguide.eu — бесплатно
Штраф: до €300
...
🇧🇴 *Боливия*
Макс. высота: 150 м | Регистрация в DGAC
Штраф: до 100 000 BOB

🇧🇦 *Босния и Герцеговина*
Макс. высота: 120 м | Регистрация в BHDCA
Штраф: до 15 000 BAM
...
🇧🇷 *Бразилия*
Макс. высота: 120 м | Регистрация в ANAC (anac.gov.br) — бесплатно
Штраф: до R$50 000

🇧🇬 *Болгария*
Макс. высота: 120 м | Регистрация в CAA (caa.bg)
Штраф: до 50 000 BGN
...
🇧🇹 *Бутан*
Разрешено с разрешением Министерства туризма
...
🇨🇦 *Канада*
Макс. высота: 122 м | Регистрация в Transport Canada (tc.canada.ca) — $5 CAD
Штраф: до $3 000 CAD

🇨🇱 *Чили*
Макс. высота: 130 м | Регистрация в DGAC (dgac.gob.cl) — бесплатно
Штраф: до 60 UTM
...
🇨🇿 *Чехия*
Макс. высота: 120 м | Регистрация: caa.cz — бесплатно
Штраф: до 100 000 CZK

🇩🇰 *Дания*
Макс. высота: 120 м | Регистрация: droneluftrum.dk — бесплатно
Штраф: до 10 000 DKK
...
Регистрация в IDAC (idac.gov.do)
Штраф: до 500 000 DOP
...
🇪🇨 *Эквадор*
Макс. высота: 120 м | Регистрация в DGAC (dgac.gob.ec)
Штраф: до $5 000
...
🇪🇪 *Эстония*
Макс. высота: 120 м | Регистрация: ecaa.ee — бесплатно
Штраф: до €1 200
...
🇫🇮 *Финляндия*
Макс. высота: 120 м | Регистрация: traficom.fi — €30
Штраф: до €2 000

🇫🇷 *Франция*
Макс. высота: 120 м | Регистрация: alphatango.aero — бесплатно
Запрет над Парижем и историческими центрами
Штраф: до €15 000
...
🇬🇭 *Гана*
Макс. высота: 400 футов | Регистрация в GCAA (gcaa.gov.gh) — $50
Штраф: до GHS 20 000
...
🇭🇷 *Хорватия*
Макс. высота: 120 м | Регистрация: ccaa.hr — бесплатно
Штраф: до €660

🇬🇷 *Греция*
Макс. высота: 120 м | Регистрация: hcaa.gr — бесплатно
Запрет над Акрополем и охраняемыми зонами
Штраф: до €300 000
...
🇬🇪 *Грузия*
Макс. высота: 100 м | Регистрация в GCAA (gcaa.gov.ge) — бесплатно
Штраф: до GEL 500

🇭🇺 *Венгрия*
Макс. высота: 120 м | Регистрация: kozkozl.hu
Штраф: до HUF 500 000

🇮🇸 *Исландия*
Макс. высота: 120 м | Регистрация: icetra.is — бесплатно
Штраф: до ISK 500 000

🇮🇪 *Ирландия*
Макс. высота: 120 м | Регистрация: iaa.ie — €30
Штраф: до €50 000

🇮🇱 *Израиль*
Регистрация в CAAI (caa.gov.il) — ₪300
Штраф: до ₪100 000

🇮🇹 *Италия*
Макс. высота: 120 м | Регистрация: d-flight.it — €35
Запрет над историческими центрами, пляжами
Штраф: до €50 000

🇯🇲 *Ямайка*
Регистрация в JCAA (jcaa.gov.jm)
Штраф: до J$5 000 000

🇯🇵 *Япония*
Макс. высота: 150 м | Регистрация: drone.mlit.go.jp — обязательна
Штраф: до ¥500 000
До 150 м — уведомительный порядок

🇯🇴 *Иордания*
Регистрация в CARC (carc.gov.jo) — JD25
Штраф: до JD50 000

🇰🇿 *Казахстан*
Макс. высота: 150 м | Регистрация в КГА (caak.kz)
Штраф: до 50 МРП

🇰🇪 *Кения*
Регистрация в KCAA (kcaa.or.ke) — KES 5 000
Штраф: до KES 1 000 000
...
🇱🇻 *Латвия*
Макс. высота: 120 м | Регистрация: caa.lv — €25
Штраф: до €1 000
...
🇱🇮 *Лихтенштейн*
Следует правилам EASA
Штраф: до CHF 5 000

🇱🇹 *Литва*
Макс. высота: 120 м | Регистрация: cregs.lt — бесплатно
Штраф: до €3 000

🇱🇺 *Люксембург*
Макс. высота: 120 м | Регистрация: laa.lu
Штраф: до €500
...
🇲🇼 *Малави*
Регистрация в DCA (dca.gov.mw)
Штраф: до MWK 5 000 000

🇲🇻 *Мальдивы*
Разрешено только вне охраняемых зон
Регистрация: caac.gov.mv
Штраф: до MVR 100 000
...
🇲🇹 *Мальта*
Макс. высота: 120 м | Регистрация: caa.com.mt — €20
Штраф: до €50 000
...
🇲🇺 *Маврикий*
Регистрация в ADSU (adsu.govmu.org) — бесплатно
Штраф: до Rs 200 000

🇲🇽 *Мексика*
Макс. высота: 120 м | Регистрация в AFAC (afac.gob.mx) — бесплатно
Штраф: до $4 000 USD
...
🇲🇨 *Монако*
Следует правилам EASA/Франции
Штраф: до €50 000

🇲🇳 *Монголия*
Регистрация в CAAC (mcaa.gov.mn)
Штраф: до MNT 5 000 000

🇲🇪 *Черногория*
Макс. высота: 120 м | Регистрация: caa.me
Штраф: до €5 000

🇲🇦 *Марокко*
Регистрация в RACAM (racam.ma) — MAD 500
Штраф: до MAD 100 000
...
🇳🇱 *Нидерланды*
Макс. высота: 120 м | Регистрация: rdi.nl — бесплатно
Штраф: до €900

🇳🇿 *Новая Зеландия*
Макс. высота: 120 м | Регистрация: aviation.govt.nz — бесплатно
Штраф: до NZ$20 000
...
🇳🇬 *Нигерия*
Регистрация в NCAA (ncaa.gov.ng) — N150 000 / год
Штраф: до N2 000 000

🇲🇰 *Северная Македония*
Макс. высота: 120 м | Регистрация: caa.mk
Штраф: до MKD 100 000

🇳🇴 *Норвегия*
Макс. высота: 120 м | Регистрация: luftfartstilsynet.no — бесплатно
Штраф: до NOK 30 000

🇴🇲 *Оман*
Регистрация в CAAM (caa.gov.om) — OMR 20
Штраф: до OMR 10 000

🇵🇦 *Панама*
Регистрация в AAC (aac.gob.pa)
Штраф: до $10 000

🇵🇬 *Папуа Новая Гвинея*
Регистрация в CASAPNG
Штраф: до K10 000

🇵🇾 *Парагвай*
Регистрация в DINAC (dinac.gov.py)
Штраф: до ₲50 000 000

🇵🇪 *Перу*
Регистрация в DGAC (dgac.gob.pe)
Штраф: до S/50 000

🇵🇭 *Филиппины*
Регистрация в CAB (caab.gov.ph) — ₱1 600
Штраф: до ₱2 000 000

🇵🇱 *Польша*
Макс. высота: 120 м | Регистрация: droneradar.eu — €8
Штраф: до PLN 30 000

🇵🇹 *Португалия*
Макс. высота: 120 м | Регистрация: anac.pt — бесплатно
Штраф: до €3 740

🇷🇴 *Румыния*
Макс. высота: 120 м | Регистрация: caa.ro — бесплатно
Штраф: до RON 10 000

🇷🇼 *Руанда*
Регистрация в RCAA (rcaa.gov.rw) — $150
Штраф: до RWF 5 000 000

🇸🇲 *Сан-Марино*
Следует правилам EASA/Италии
Штраф: до €50 000

🇸🇹 *Сан-Томе и Принсипи*
Регистрация в AAASTP
Штраф: до STN 10 000

🇸🇦 *Саудовская Аравия*
Регистрация в GACA (gaca.gov.sa) — SAR 200
Штраф: до SAR 100 000

🇸🇳 *Сенегал*
Регистрация в ANACIM
Штраф: до XOF 10 000 000

🇷🇸 *Сербия*
Макс. высота: 120 м | Регистрация: caa.rs
Штраф: до RSD 200 000
...
🇸🇰 *Словакия*
Макс. высота: 120 м | Регистрация: caa.sk — бесплатно
Штраф: до €300

🇸🇮 *Словения*
Макс. высота: 120 м | Регистрация: caa.si
Штраф: до €8 000
...
🇿🇦 *ЮАР*
Макс. высота: 122 м | Регистрация в SACAA (sacaa.org.za) — R1 200
Штраф: до R50 000 или тюрьма
...
🇪🇸 *Испания*
Макс. высота: 120 м | Регистрация: enaire.es — бесплатно
Штраф: до €225 000

🇱🇰 *Шри-Ланка*
Регистрация в CAASL (caa.lk) — LKR 10 000
Штраф: до LKR 500 000
...
🇸🇪 *Швеция*
Макс. высота: 120 м | Регистрация: transportstyrelsen.se — SEK 600
Штраф: до SEK 150 000

🇨🇭 *Швейцария*
Макс. высота: 120 м | Регистрация: bazl.admin.ch — CHF 70
Штраф: до CHF 20 000

🇹🇿 *Танзания*
Регистрация в TCAA (tcaa.go.tz) — $50
Штраф: до TZS 20 000 000

🇹🇭 *Таиланд*
Регистрация в NBTC (ntbc.or.th) — THB 500
...
🇹🇹 *Тринидад и Тобаго*
Регистрация в TTCAA (ttcaa.com) — TT$1 000
Штраф: до TT$100 000

🇹🇳 *Тунис*
Регистрация в OACA (oaca.nat.tn) — TND 100
Штраф: до TND 50 000

🇹🇷 *Турция*
Макс. высота: 120 м | Регистрация: shgm.gov.tr — ₺500
Штраф: до ₺30 000

🇺🇬 *Уганда*
Регистрация в UCAA (caa.go.ug) — $200
Штраф: до UGX 10 000 000

🇺🇦 *Украина*
Макс. высота: 120 м | Регистрация в ГСАВИАЦИИ (avia.gov.ua)
Военные зоны — полный запрет
Штраф: до UAH 51 000

🇬🇧 *Великобритания*
Макс. высота: 120 м | Регистрация: register-drones.service.gov.uk — £9/год
Штраф: до £2 500

🇺🇿 *Узбекистан*
Регистрация в Госкомитете гражданской авиации
Штраф: до 100 базовых величин

🇻🇺 *Вануату*
Регистрация в VANUATU CAA
Штраф: до VT 500 000

🇻🇪 *Венесуэла*
Регистрация в INAC (inac.gob.ve)
Штраф: до BsD 10 000

🇻🇳 *Вьетнам*
Разрешено с разрешением — фактически нужно спецразрешение для иностранцев
Штраф: до VND 40 000 000

🇿🇲 *Замбия*
Регистрация в DCAA (dcaa.gov.zm) — K500
Штраф: до K100 000

🇿🇼 *Зимбабве*
Регистрация в CAAZ (caaz.co.zw) — $150
Штраф: до $200 000

⚠️ Правила меняются — проверяй на сайте авиационного ведомства страны перед поездкой"""

DRONE_PERMIT_TEXT = """📋 *Дроны: Нужно разрешение заранее*

Для полётов необходимо оформить документы ДО поездки.

🇦🇪 *ОАЭ*
Что оформить: разрешение GCAA + регистрация на dcaa.gov.ae
Орган: GCAA (gcaa.gov.ae)
Стоимость: AED 300-500
Срок: 5-10 рабочих дней
Штраф: до AED 20 000 и тюрьма

📌 Инструкция ОАЭ:
1. Зарегистрируйся на dcaa.gov.ae
2. Загрузи данные дрона (серийный номер, вес)
3. Оплати сбор AED 300
4. Получи разрешение за 5-10 дней
5. В аэропорту декларируй дрон

🇧🇭 *Бахрейн*
Что оформить: разрешение CAA
Орган: BCAA (caa.gov.bh)
Стоимость: BHD 50
Срок: 10 рабочих дней
Штраф: до BHD 10 000

📌 Инструкция Бахрейн:
1. Подай заявку на caa.gov.bh
2. Укажи маршрут и цель съёмки
3. Оплати BHD 50
4. Получи разрешение по email

🇨🇳 *Китай*
Что оформить: регистрация CAAC + разрешение на каждый полёт в зонах
Орган: CAAC (caac.gov.cn)
Стоимость: бесплатно (регистрация)
Штраф: до ¥500 000 + уголовная ответственность

📌 Инструкция Китай:
1. Установи приложение UTMISS или UAS
2. Зарегистрируй дрон на ucas.caac.gov.cn
3. Перед каждым полётом проверяй зоны в приложении
4. В нацпарках и городских зонах — отдельное разрешение
5. Дрон DJI автоматически блокирует запрещённые зоны в Китае
...
📌 Инструкция Куба:
1. Отправь заявление в IACC на iacc.cu за месяц
2. Задекларируй дрон на таможне при въезде
3. Съёмка военных объектов и портов — абсолютный запрет

🇪🇬 *Египет*
Что оформить: разрешение ECAA + таможенная декларация
Орган: ECAA (ecaa.gov.eg)
Стоимость: EGP 1 000-5 000
Срок: 2-4 недели
Штраф: конфискация + до 3 лет тюрьмы

📌 Инструкция Египет:
1. Подай заявку в ECAA за 2-4 недели
2. При въезде задекларируй дрон на таможне
3. Без разрешения дрон конфискуют прямо в аэропорту
4. Съёмка пирамид — нужно отдельное разрешение Ministry of Antiquities

🇮🇳 *Индия*
Что оформить: регистрация в Digital Sky Platform
Орган: DGCA (digitalsky.dgca.gov.in)
Стоимость: бесплатно (до 2 кг — Nano: без регистрации)
Срок: 1-3 дня
Штраф: до ₹1 000 000 + тюрьма до 2 лет

📌 Инструкция Индия:
1. Зарегистрируйся на digitalsky.dgca.gov.in
2. Выбери категорию дрона (Nano/Micro/Small/Medium/Large)
3. Дроны до 250 г (Nano) — без регистрации, летать только в Green зонах
4. Проверяй зоны в приложении Digital Sky
5. Красные зоны (аэропорты, границы) — полный запрет

🇮🇩 *Индонезия*
Что оформить: регистрация в DGCA + разрешение для каждого района
Орган: DGCA (hubud.dephub.go.id)
Стоимость: IDR 350 000
Срок: 5-14 дней
Штраф: до IDR 3 000 000 000

📌 Инструкция Индонезия:
1. Зарегистрируй дрон на e-registrasi.dephub.go.id
2. Для Бали: разрешение у местной авиации + Управления нацпарка
3. Над храмами (Borobudur, Prambanan) — абсолютный запрет
4. Съёмка туристических зон только с разрешения BBTNGR (Бали)

🇮🇷 *Иран*
Что оформить: разрешение CAO
Орган: CAO (cao.ir)
Стоимость: $50-200
...
🇮🇶 *Ирак*
Что оформить: разрешение ICAA
Орган: ICAA
Стоимость: уточняй в посольстве
Штраф: конфискация + тюрьма

🇰🇼 *Кувейт*
Что оформить: разрешение DGCA
Орган: DGCA (dgca.gov.kw)
Стоимость: KWD 20-100
Срок: 2 недели
Штраф: конфискация + до KWD 50 000

📌 Инструкция Кувейт:
1. Подай заявление на dgca.gov.kw
2. Укажи модель, серийный номер, зону полёта
3. Получи письменное разрешение
4. При полёте всегда имей разрешение при себе

🇱🇧 *Ливан*
Что оформить: разрешение CAA
Орган: DGCA (dgca.gov.lb)
Штраф: конфискация + штраф

🇲🇾 *Малайзия*
Что оформить: регистрация CAAM + разрешение для коммерческих
Орган: CAAM (caam.gov.my)
Стоимость: MYR 100-500
Срок: 3-5 дней
Штраф: до MYR 50 000

📌 Инструкция Малайзия:
1. Зарегистрируй дрон на portal.caam.gov.my
2. Дроны до 250 г — регистрация не нужна, летать в Green зонах
3. Над Куала-Лумпуром (Petronas, KLIA) — спецразрешение
4. Прибрежные зоны Борнео — разрешение у местного военного ведомства

🇲🇲 *Мьянма*
Что оформить: разрешение Министерства транспорта и МККАД
Орган: DGCA Myanmar
Стоимость: уточняй заранее
Срок: 2-4 недели
Штраф: конфискация + тюрьма

📌 Инструкция Мьянма:
1. Подай запрос через посольство или туроператора
2. Предоставь паспортные данные и характеристики дрона
3. Ограничения особо жёсткие у буддийских святынь

🇳🇵 *Непал*
Что оформить: разрешение CAAN
Орган: CAAN (caanepal.org.np)
Стоимость: $50-250 в зависимости от зоны
Срок: 1-3 недели
Штраф: до NPR 500 000

📌 Инструкция Непал:
1. Подай заявку на caanepal.org.np
2. Для нацпарков (Эверест, Аннапурна) — разрешение DNPWC + CAAN
3. Стоимость варьируется: Everest area — $250, города — $50
4. Без разрешения дрон конфискуют на контрольно-пропускных пунктах

🇵🇰 *Пакистан*
Что оформить: разрешение CAA
Орган: CAA (caapakistan.com.pk)
Стоимость: PKR 10 000
Срок: 3-4 недели
Штраф: конфискация + тюрьма

🇶🇦 *Катар*
Что оформить: разрешение QCAA
Орган: QCAA (qcaa.gov.qa)
Стоимость: QAR 100-500
Срок: 5-10 дней
Штраф: до QAR 200 000

📌 Инструкция Катар:
1. Зарегистрируйся на portal.qcaa.gov.qa
2. Подай заявку за 10 дней
3. В зонах Fan Zones и Lusail — отдельные ограничения

🇹🇿 *Танзания (Занзибар)*
Для Занзибара — отдельное разрешение Занзибарского правительства
Орган: ZAC (zac.go.tz)
Стоимость: $200
Срок: 2 недели
...
DRONE_BANNED_TEXT = """🚫 *Дроны: Полностью запрещено*

В этих странах полёты дронов запрещены законом.

🇦🇫 *Афганистан*
Запрещено для туристов и иностранцев
Наказание: конфискация + задержание властями

🇧🇧 *Барбадос* (над пляжами и заповедниками)
Запрет в охраняемых прибрежных зонах
...
🇬🇪 *Грузия* (ограниченные зоны)
Запрет над военными базами, зонами конфликтов (Абхазия, Ю.Осетия)
Штраф: до GEL 500
...
🇮🇶 *Ирак*
Запрещено для туристов без специального разрешения
Наказание: конфискация + задержание

🇰🇵 *КНДР*
Абсолютный запрет
Наказание: арест + уголовное преследование
...
Запрет над Королевскими дворцами, военными базами, Сахарой (часть)
Штраф: до MAD 100 000 + тюрьма

🇲🇿 *Мозамбик* (без регистрации)
Полёт без регистрации = конфискация
Штраф: до MZN 500 000

🇲🇲 *Мьянма* (для туристов без разрешения)
Конфискация при въезде если нет разрешения
Наказание: тюрьма до 3 лет
...
Конфискация + уголовное преследование
Штраф: тюрьма до 2 лет

🇸🇦 *Саудовская Аравия* (Мекка, Медина)
Абсолютный запрет над священными городами
Наказание: конфискация + тюрьма

🇸🇾 *Сирия*
Полный запрет
Наказание: конфискация + немедленный арест

🇸🇩 *Судан* (без разрешения)
Конфискация + штраф
Наказание: тюрьма возможна

🇹🇯 *Таджикистан* (без разрешения)
Конфискация на границе
Штраф: до 50 000 TJS

🇹🇭 *Таиланд* (Чиангмай, фестиваль фонарей)
Запрет над национальными парками и пляжами Паттайи без разрешения
Штраф: до THB 40 000 или тюрьма 1 год
...
Штраф: немедленное задержание + штраф (Италия/Ватикан)

🇸🇬 *Сингапур*
Полёты запрещены без разрешения CAAS
Орган: caas.gov.sg | Штраф: до S$20 000 или тюрьма 12 месяцев

🇧🇳 *Бруней*
Полёты запрещены без разрешения CABD
Штраф: до BND 100 000

🌐 *Универсальные запретные зоны (везде)*
— Аэропорты и воздушные подходы к ним (5-10 км)
— Военные базы и объекты
— Атомные станции и стратегические объекты
— Государственные резиденции и дворцы
— Места проведения массовых мероприятий
— Национальные парки (в большинстве стран)
— Над людьми и населёнными пунктами (везде ограничено)
...
async def drone_menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🚁 *Дроны в путешествиях*\n\nВыбери раздел:",
                                     parse_mode="Markdown", reply_markup=keyboard)
    return DRONE_MENU


async def drone_section_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = update.message.text
    if text == "✅ Можно летать":
        reply = DRONE_ALLOWED_TEXT
    elif text == "📋 Нужно разрешение":
        reply = DRONE_PERMIT_TEXT
    elif text == "🚫 Запрещено":
        reply = DRONE_BANNED_TEXT
    elif text == "⚠️ Общие правила везде":
        reply = DRONE_RULES_TEXT
    else:
        return await go_home(update, context)
    ...
    if len(reply) <= MAX:
        ...
        for i, part in enumerate(parts):
            await update.message.reply_text(part, parse_mode="Markdown",
                                             reply_markup=keyboard if i == len(parts)-1 else ReplyKeyboardRemove())
    return DRONE_MENU
...
def main():
    ...
    conv = ConversationHandler(
        ...
        states={
            ...
            DRONE_MENU: [
                MessageHandler(filters.Regex("^(✅ Можно летать|📋 Нужно разрешение|🚫 Запрещено|⚠️ Общие правила везде)$"), drone_section_handler),
                MessageHandler(filters.Regex(f"^{re.escape(HOME_BTN)}$"), go_home),
            ],
        },
        fallbacks=[
            home,
