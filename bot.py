...
async def main_menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ── Feature buttons ──────────────────────────────────────────────────────
        ...
        await update.message.reply_text(
            ...
            "В прошлом году я ушёл с нелюбимой работы. Решил заниматься только тем, от чего горят глаза. Путешествия — именно это.\n\n"
            "🌍 Немного цифр:\n"
            ...
            "— Все страны — без знания английского языка\n"
