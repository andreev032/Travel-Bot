...
HELP_TOPICS = {
    ...
    "🎒 Как упаковать рюкзак": (
        "🎒 *Как упаковать рюкзак*\n\n"
        "Принцип укладки:\n"
        "— Тяжёлое (ноутбук, обувь) — ближе к спине и в нижнюю часть.\n"
        "— Лёгкое (одежда, спальник) — в остальное пространство.\n"
        "— Частое (куртка, перекус, зарядки) — в верхний клапан и боковые карманы.\n\n"
        "Что брать:\n"
        "— Одежда по правилу 1-2-3: 1 на себе, 2 в запасе, 3 пары носков.\n"
        "— Универсальная обувь: кроссовки на каждый день + сандалии или флипфлопы.\n"
        "— Компактное полотенце из микрофибры — в 5 раз меньше обычного.\n"
        "— Замок для рюкзака — защита в хостелах и автобусах.\n\n"
        "Что не брать:\n"
        "— Лишние провода — возьми один универсальный кабель USB-C.\n"
        "— Книги в бумаге — замени на электронную читалку.\n"
        "— Полные флаконы косметики — перелей в маленькие тюбики (до 100 мл).\n"
        "— «На всякий случай» — если не можешь назвать 3 ситуации, не бери.\n\n"
        "💡 *Совет:* Взвесь рюкзак перед выходом. Идеал — не больше 10% твоего веса тела."
    ),
    "🛃 Как вести себя на таможне": (
        "🛃 *Как вести себя на таможне*\n\n"
        "Общие правила:\n"
        "— Будь спокоен и вежлив — офицеры реагируют на нервозность.\n"
        "— Отвечай кратко и честно: цель поездки, сколько дней, где остановился.\n"
        "— Не шути про оружие, наркотики и бомбы — даже если это «очевидно смешно».\n\n"
        "Что декларировать:\n"
        "— Наличные свыше $10 000 (или эквивалент) — обязательно везде.\n"
        "— Дорогие вещи (камеры, ноутбуки) при въезде в некоторые страны.\n"
        "— Алкоголь и табак сверх нормы страны назначения.\n"
        "— Продукты животного происхождения (мясо, молоко, яйца) — во многих странах запрещены.\n\n"
        "Что нельзя везти:\n"
        "— Наркотики — нулевая толерантность даже в «мягких» странах.\n"
        "— Некоторые лекарства (кодеин, сильные снотворные) — возьми справку от врача.\n"
        "— Электронные сигареты и вейпы — запрещены в Таиланде, ОАЭ и других странах.\n\n"
        "💡 *Совет:* При въезде в ОАЭ, Сингапур и Японию таможня особенно строгая — изучи правила заранее."
    ),
    "💊 Аптечка путешественника": (
        "💊 *Аптечка путешественника*\n\n"
        "Базовый набор:\n"
        "— Обезболивающее/жаропонижающее: ибупрофен или парацетамол.\n"
        "— Антидиарейное: лоперамид (имодиум) — первая помощь при расстройстве.\n"
        "— Регидрон или аналог — восстановление водно-солевого баланса.\n"
        "— Антигистаминное: лоратадин или цетиризин — от аллергии и укусов.\n"
        "— Пластырь бактерицидный (разных размеров) и стерильные салфетки.\n"
        "— Антисептик: хлоргексидин или спиртовые салфетки.\n\n"
        "По направлению:\n"
        "— Азия, Африка, Латинская Америка: таблетки от малярии (по назначению врача).\n"
        "— Горы: средство от высотной болезни (ацетазоламид — по рецепту).\n"
        "— Жаркие страны: крем от солнца SPF 50+ и средство от насекомых с DEET.\n"
        "— Всегда: запас личных лекарств с запасом на 2–3 дня сверх поездки.\n\n"
        "Важно:\n"
        "— Храни рецептурные лекарства в оригинальной упаковке с рецептом.\n"
        "— Жидкости — в пакет до 1 литра, каждый флакон до 100 мл.\n\n"
        "💡 *Совет:* Сфотографируй аптечку перед поездкой — проще будет найти аналоги за рубежом."
    ),
    "📱 Приложения для путешественников": (
        "📱 *Топ-10 приложений для путешественника*\n\n"
        "Навигация:\n"
        "— *Google Maps* — скачай офлайн-карту нужного города дома.\n"
        "— *Maps.me* — детальные офлайн-карты, работает в горах и без сети.\n\n"
        "Транспорт и жильё:\n"
        "— *Aviasales* — поиск дешёвых авиабилетов из России.\n"
        "— *Booking.com* — отели с бесплатной отменой, читай отзывы.\n"
        "— *Airbnb* — апартаменты и необычное жильё.\n\n"
        "Деньги:\n"
        "— *Wise* (TransferWise) — выгодный обмен валюты и переводы.\n"
        "— *XE Currency* — конвертер валют офлайн.\n\n"
        "Безопасность и связь:\n"
        "— *Airalo* — покупка eSIM для интернета в любой стране.\n"
        "— *Google Translate* — переводчик с камерой (переводит меню и знаки).\n\n"
        "Планирование:\n"
        "— *TripIt* — автоматически собирает маршрут из писем на почте.\n\n"
        "💡 *Совет:* Скачай все нужные карты и переводы офлайн ещё дома — в роуминге интернет дорогой."
    ),
    "🕵️ Мошенники в туристических местах": (
        "🕵️ *Мошенники в туристических местах*\n\n"
        "Классические схемы:\n"
        "— *«Что-то пролили»* — пока один отвлекает и «помогает», другой чистит карманы.\n"
        "— *«Бесплатный подарок»* — браслет, цветок, фигурка — потом агрессивно требуют деньги.\n"
        "— *«Фото за деньги»* — человек в костюме сам встаёт рядом, потом требует оплату.\n"
        "— *«Закрыт главный вход»* — «помощник» ведёт в магазин друга вместо музея.\n"
        "— *«Игра напёрстки/карты»* — всегда проигрышная, участники в сговоре.\n"
        "— *«Такси без счётчика»* — всегда договаривайся о цене ДО посадки.\n\n"
        "Горячие точки:\n"
        "— Рим (Колизей), Барселона (Рамбла), Бангкок (Каосан Роад), Каир (пирамиды).\n\n"
        "Как защититься:\n"
        "— Не останавливайся, если незнакомец резко подходит и начинает разговор.\n"
        "— Сумку носи спереди, застёгнутой.\n"
        "— Не доставай телефон и кошелёк в толпе без необходимости.\n\n"
        "💡 *Совет:* Если чувствуешь давление — просто уходи. Вежливость здесь не обязательна."
    ),
    "🆘 Что делать если обокрали": (
        "🆘 *Что делать если обокрали*\n\n"
        "Первые шаги:\n"
        "1. Убедись в собственной безопасности — отойди в людное место.\n"
        "2. Проверь, что именно пропало: телефон, кошелёк, карты, документы.\n\n"
        "Если украли карту:\n"
        "— Заблокируй немедленно через приложение банка или звонок на горячую линию.\n"
        "— Большинство банков позволяют заморозить карту за 10 секунд в приложении.\n\n"
        "Если украли телефон:\n"
        "— Войди на find.google.com или appleid.apple.com — заблокируй удалённо.\n"
        "— Смени пароли от почты, соцсетей, мессенджеров с другого устройства.\n\n"
        "Если украли документы:\n"
        "— Обратись в полицию — получи справку об утере (нужна для посольства).\n"
        "— Свяжись с посольством России — выдадут временное свидетельство на возвращение.\n\n"
        "Страховка:\n"
        "— Сообщи страховой компании в течение 24 часов — большинство полисов покрывают кражу.\n"
        "— Сохрани справку из полиции — без неё страховая не выплатит.\n\n"
        "💡 *Совет:* Заранее запиши номер горячей линии банка и посольства в заметки — без телефона не найдёшь."
    ),
    "🚫 Запреты и табу в разных странах": (
        ...
        "— 🇹🇭 Таиланд: нельзя есть и пить в храмах.\n\n"
        "Одежда:\n"
        "— Мечети везде: покрытые плечи и колени, женщинам — платок на голову.\n"
        "— 🇮🇷 Иран: женщинам хиджаб обязателен на улице.\n"
        "— 🇮🇩 Индонезия (Бали): не заходи в храм в шортах без саронга.\n\n"
        "Поведение:\n"
        "— 🇯🇵 Япония: не говори громко в транспорте, не ешь на ходу.\n"
        "— 🇹🇭 Таиланд: никогда не касайся головы другого человека — она священна.\n"
        "— 🇨🇳 Китай: не втыкай палочки вертикально в рис — символ похорон.\n"
        "— 🇬🇷 Греция: знак «окей» пальцами — оскорбление.\n\n"
        "Фото:\n"
        "— Во многих странах нельзя фотографировать военные объекты, аэропорты, полицию.\n"
        "— 🇲🇾 Малайзия, 🇱🇰 Шри-Ланка: селфи на фоне статуи Будды спиной к ней — штраф.\n\n"
        "💡 *Совет:* Перед поездкой погугли «что нельзя делать в [страна]» — 10 минут сэкономят тебе штраф."
    ),
    "💰 Чаевые по странам": (
        "💰 *Чаевые по странам — где обязательно, где не принято*\n\n"
        "Обязательно (обидно не оставить):\n"
        "— 🇺🇸 США, 🇨🇦 Канада: 15–20% в ресторане, $1–2 бармену, $2–5 такси.\n"
        "— 🇲🇽 Мексика: 10–15% в ресторанах.\n"
        "— 🇪🇬 Египет, 🇲🇦 Марокко: чаевые ожидаются везде, даже за «случайную» помощь.\n\n"
        "Приветствуется, но необязательно:\n"
        "— 🇩🇪 Германия, 🇦🇹 Австрия: округли счёт вверх или оставь 5–10%.\n"
        "— 🇬🇧 Великобритания: 10–12,5% если не включено в счёт (check for «service charge»).\n"
        "— 🇹🇷 Турция: 10% в ресторанах, мелочь экскурсоводам.\n"
        "— 🇹🇭 Таиланд: 20–50 бат в ресторане, не обязательно, но приятно.\n\n"
        "Не принято или даже обидно:\n"
        "— 🇯🇵 Япония: чаевые — табу, могут вернуть обратно со смущением.\n"
        "— 🇨🇳 Китай: в большинстве заведений чаевые не ожидаются.\n"
        "— 🇸🇬 Сингапур: сервисный сбор уже включён в счёт (10%), отдельно не нужно.\n"
        "— 🇦🇺 Австралия, 🇳🇿 Новая Зеландия: не обязательно, официанты получают высокую зарплату.\n\n"
        "💡 *Совет:* Если не знаешь — посмотри на счёт: есть «service charge» или «gratuity» — уже включено."
    ),
}
