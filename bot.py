...
QUESTIONS = [
    ...
    {"id": "goal", "text": "Главная цель поездки?", "opts": ["Полностью отключиться", "Увидеть максимум мест", "Погрузиться в культуру", "Совместить работу и отдых"]},
]
...
DESTINATIONS = [
    ...
    {"country": "Камбоджа", "city": "Сием Рип", "flag": "🇰🇭", "why": "Ангкор Ват — одно из величайших чудес света и древняя цивилизация вокруг.", "highlight": "Ангкор Ват на рассвете, плавучие деревни и закаты", "best_time": "Ноябрь – март", "budget": "от 1 800 ₽/день", "tip": "Вставай в 4 утра чтобы встретить рассвет в Ангкор Вате — незабываемо", "visa": "E-visa 30 долларов", "tags": {"nature": ["Джунгли и экзотика", "Города и культура"], "climate": ["Жара +30 и выше"], "budget": ["До 50 000 ₽"], "vibe": ["Культура и история", "Полный отдых и пляж"]}},
    {"country": "Турция", "city": "Стамбул", "flag": "🇹🇷", "why": "Два континента, тысячелетняя история, море и отличная кухня по доступным ценам.", "highlight": "Голубая мечеть, Каппадокия и Средиземноморское побережье", "best_time": "Апрель – июнь, сентябрь – ноябрь", "budget": "от 3 000 ₽/день", "tip": "Стамбульская карта выгоднее разовых билетов — купи сразу на несколько поездок", "visa": "Безвизово 60 дней", "tags": {"nature": ["Море и пляжи", "Города и культура"], "climate": ["Тепло +20–28", "Жара +30 и выше"], "budget": ["До 50 000 ₽", "50–100 000 ₽"], "vibe": ["Культура и история", "Гастрономия и рынки"]}},
    {"country": "Филиппины", "city": "Манила", "flag": "🇵🇭", "why": "Более 7000 островов с бирюзовой водой, кораллами и белым песком.", "highlight": "Острова Палаван, Боракай и дайвинг", "best_time": "Декабрь – май", "budget": "от 2 500 ₽/день", "tip": "Летай внутренними рейсами Cebu Pacific — дёшево и быстро между островами", "visa": "Безвизово 30 дней", "tags": {"nature": ["Море и пляжи", "Джунгли и экзотика"], "climate": ["Жара +30 и выше"], "budget": ["До 50 000 ₽", "50–100 000 ₽"], "vibe": ["Полный отдых и пляж", "Экстрим и активность"]}},
...
async def show_result(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = (
        ...
        f"Хочешь пройти ещё раз? Напиши /start"
    )
...
async def cancel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Окей, до встречи! Напиши /start чтобы начать заново.", reply_markup=ReplyKeyboardRemove())
    return ConversationHandler.END
